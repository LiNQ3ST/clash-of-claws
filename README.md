...
| 4 — Marketplace & Trading | Todd Gonzales | toddgonzales-xg | #9, #10, #11, #12 | `todd/trader` `todd/trader-scene` `todd/trader-service` `todd/trader-notifications-testfx` `todd/ui-design-change`                                                                                   | [#25](https://github.com/LiNQ3ST/clash-of-claws/pull/25) | Notifications / alerts | in-progress|
