...
|-------|--------------|-----------------|----------------|---------------|-----|--------------------|--------|
| 1 — Accounts | Sahtra Green | SahtraRG | #5, #6, #7, #8 | `sahtra/player-data`, `sahtra/account-scenes` | [#23](https://github.com/LiNQ3ST/clash-of-claws/pull/23), [#26](https://github.com/LiNQ3ST/clash-of-claws/pull/26), [#32](https://github.com/LiNQ3ST/clash-of-claws/pull/32) | Custom reusable FXML component | in-progress |
